...
const Home: NextPage = () => {
    ...
    return (
        <div className={'flex h-screen w-screen bg-[url(/background.svg)] bg-no-repeat bg-center bg-cover'}>
            <div className="m-auto">
                <div className="p-4 rounded grow">
                    <div className="text-center mb-10">
                        <Image width={150} height={150} src={"/brand-logo.svg"} alt="Admin Panel" />
                    </div>
